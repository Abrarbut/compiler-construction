...
{
  "\"end of file\"", "error", "\"invalid token\"", "NUMBER", "LOG",
  "EXP_FUNC", "'+'", "'-'", "'*'", "'/'", "'^'", "UMINUS", "'\\n'", "'('",
  "')'", "$accept", "program", "line", "expr", "term", "power", "factor", YY_NULLPTR
};
...
{
     -11,     0,   -11,   -10,   -11,    -7,    -5,    11,   -11,    11,
     -11,    26,    17,   -11,     1,   -11,    11,    11,   -11,     3,
      11,    11,   -11,    11,    11,    11,    13,    15,   -11,    17,
      17,   -11,   -11,   -11,   -11,   -11
};
...
{
       2,     0,     1,     0,    15,     0,     0,     0,     5,     0,
       3,     0,     9,    12,    14,     6,     0,     0,    17,     0,
       0,     0,     4,     0,     0,     0,     0,     0,    16,     7,
       8,    10,    11,    13,    18,    19
};
...
{
       2,     3,    15,     4,     5,     6,    16,     7,    17,    20,
      21,    25,     8,     9,     4,     5,     6,    28,     7,    20,
      21,    20,    21,    19,     9,    23,    24,    34,    18,    35,
      26,    27,    20,    21,     0,    31,    32,    33,    22,    29,
      30
};

static const yytype_int8 yycheck[] =
{
       0,     1,    12,     3,     4,     5,    13,     7,    13,     6,
       7,    10,    12,    13,     3,     4,     5,    14,     7,     6,
       7,     6,     7,     9,    13,     8,     9,    14,     7,    14,
      16,    17,     6,     7,    -1,    23,    24,    25,    12,    20,
      21
};
...
{
       0,    16,     0,     1,     3,     4,     5,     7,    12,    13,
      17,    18,    19,    20,    21,    12,    13,    13,    21,    18,
       6,     7,    12,     8,     9,    10,    18,    18,    14,    19,
      19,    20,    20,    20,    14,    14
};
...
#line 66 "calc.y"
                                {
                                  if ((yyvsp[-1].dval) <= 0.0) {
                                      ...
                                      (yyval.dval) = log((yyvsp[-1].dval));   /* natural log */
                                  }
                                }
#line 1194 "calc.tab.c"
    break;

  case 19: /* factor: EXP_FUNC '(' expr ')'  */
#line 74 "calc.y"
